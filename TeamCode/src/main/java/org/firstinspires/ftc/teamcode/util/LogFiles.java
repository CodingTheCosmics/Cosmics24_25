...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = OdometryDrive.TRANSLATIONAL_PID.kP;
        public double mecTransI = OdometryDrive.TRANSLATIONAL_PID.kI;
        public double mecTransD = OdometryDrive.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = OdometryDrive.HEADING_PID.kP;
        public double mecHeadingI = OdometryDrive.HEADING_PID.kI;
        public double mecHeadingD = OdometryDrive.HEADING_PID.kD;
        public double mecLateralMultiplier = OdometryDrive.LATERAL_MULTIPLIER;
